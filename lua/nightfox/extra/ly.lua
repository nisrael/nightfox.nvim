...
function M.generate(spec, _)
  ...
  local lines = {
    ...
    "#",
    "# These keys only color ly's own UI. To also theme the Linux console",
    "# palette behind it, install the sibling `ly-startup.sh` as",
    "# /etc/ly/startup.sh (config.ini: `start_cmd`).",
    "",
    "# Login box",
    "fg = " .. color(spec.fg1),
    "bg = " .. color(spec.bg1),
